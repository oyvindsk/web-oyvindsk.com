...
[role=lead]
Hi, I'm Øyvind. *I build fast, scalable and secure backend systems for startups and scaleups*. I work as an independent consultant, developer and architect, and I'm based in Oslo, Norway.
...
Or are you worried it's not secure enough? Maybe it was vibecoded? Or built by frontend and fullstack people whose expertise mainly lie elsewhere.

My specialty is back-end, server-side technology and architecture. I help build, scale and fix back-end systems in the cloud or on "bare metal".

*Please don't hesitate to contact me*.

link:https://oyvindsk.com/contact[Just give me a call, fill out this form] or message me on LinkedIn.
I am very friendly and I can steer you in the right direction if I'm too busy to help, or not the right kind of developer you need. I've also gotten to know many other freelancers, independent contractors and designers.
...
I strongly prefer simplicity and strive for it whenever possible. Especially when working with startups, where speed of development and change is very important.


=== Technology

My current language of choice is link:http://golang.org[Go (golang)] and I build systems on the link:http://cloud.google.com[Google Cloud Platform]. In 2026 there is also a lot of talk of moving away from US cloud companies. I curently run my new personal projects on in link:https://freebsd.org[FreeBSD jails] on link:https://hetzner.com[Hetzner] (a German cloud and server provider).
...
Having said that, there are reasons I choose to work with Go and the Google Cloud Platform. I like Go, both the simplicity of the language and the culture of pragmatism. It's a language very well suited for building back-end servers. Google Cloud Platform also has its strengths. I've always been a fan of their first platform-as-a-service, App Engine, and Cloud Run They also seem to have a even stronger focus on pay-for-what-you-use than other cloud providers.
...
I've worked with several databases and datastores, both the Google Cloud native ones:
...
link:https://www.mysql.com/[MySQL / MariaDB] and
link:https://www.postgresql.org/[PostgreSQL] extensively, as well as others such as
link:https://redis.io/[Redis],
link:https://sqlite.org[SQLite] and link:https://arangodb.com/[ArangoDB].
...
== Background
After finishing my MSc in Informatics in 2010 I worked as a back-end developer, and "devops" guy for almost 4 years before I started my own company in 2014. Since then I’ve taken contract work and worked on many projects for different clients. 

For examples of what I've done for my past clients, see link:https://oyvindsk.com/projects[past clients and projects].
...
[[availability]]
== Availability
I'm curently stepping back from Fractional CTO work and looking for new oppertunities.
