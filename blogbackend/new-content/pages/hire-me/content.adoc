...
My specialty is back-end, server-side technology and architecture. I help startups and scaleups build and scale cloud-based systems.
...
I'm curently advising an early stage startup. I'm also looking for more work since this project only takes a few hours a week.
